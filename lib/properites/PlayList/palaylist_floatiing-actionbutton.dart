...
import '../../db/provider/play_listsong.dart';

class FloatingActionButtonPlayListWidget extends StatelessWidget {
  FloatingActionButtonPlayListWidget({Key? key, required this.playlist})
      : super(key: key);
      ...
      builder: ((context, value, child) => Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(colors: [
                Color.fromARGB(255, 49, 39, 39),
                Color.fromARGB(255, 41, 29, 29)
              ], stops: [
                0.5,
                1
